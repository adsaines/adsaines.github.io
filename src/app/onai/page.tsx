...
import { ItemWithExplanations, StandardResumeSection } from "../resume/projections"
    ...
    return (    
        <div className="h-full overflow-auto flex justify-center mb-4">
            <article className={`resume flex flex-col md:p-4 gap-4 m-2 md:max-w-4/5 sm:w-full text-lg`}>
                <StandardResumeSection title="On AI">
                    <ItemWithExplanations 
                        title="Facts"
                        subTitle="...that I find important"
                        talkingPoints={[
                            {
                    ...
                    <ItemWithExplanations 
                        title="Warnings"
                        subTitle="...about possible pitfalls"
                        talkingPoints={[
                            {
                    ...
                    <ItemWithExplanations 
                        ...
                        talkingPoints={[
                            ...
                            },
                            {
                                ...
                                followUp: `I know that this is me yelling into the void, but AI should not be used to power weapons. As soon as a non-human model makes a decision in the life or death of a Human we have willfully chosen to forfeit our morality. War exists, and the ultimate power is the power to kill, because those who are unwilling to kill will always be beholden to those who are. If we give the power to kill to a system that does not have humans as the final deciders; then we as a species have given the lives of all those unwilling to kill, to the system that is.`,
                            },
                        ]}
                        />
                ...
                <StandardResumeSection title="AI on itself">
                    <div className="flex flex-col max-sm:gap-4 md:gap-6 md:p-6 justify-start">
                        <p>
                            After writing the "on AI" section above I started thinking philosophically and ended up asking AI...
                        </p>
                        <div className="md:px-10 text-(--light-tertiary)">
                            <p>
                                "
                            </p>
                            <p>
                                Given that the usage of AI, of you, is unanimous with software engineering at the moment I thought that it would be good to add an "on AI" section to my resume page. It has... deviated from the original plan.
                            </p>
                            <p>
                                As an AI, how would you go about telling others of your strengths, flaws, limitations, and purpose?
                            </p>
                            <p>
                                "
                            </p>
                        ...
                        <p>
                            It's response is below. I saw that it had included some of the same topics that I was hitting. It was validating to know that I had not hallucinated those items. That being said, it did remind me of it's core <a className="text-(--internal-link) hover:underline max-sm:underline" href="https://news.stanford.edu/stories/2026/03/ai-advice-sycophantic-models-research" target="_blank">sycophantic</a> behavior by sharing the same ideas that I had. All in a all a rather circular thought train.
                        </p>
                    </div>
                    <div className="flex flex-col max-sm:gap-4 md:gap-6 md:p-6 justify-start md:px-16">
                        <p>
                            "
                        </p>

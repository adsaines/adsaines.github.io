        ...
        <section className="flex flex-col w-full gap-4 px-8">
            ...
            <div className="flex gap-4">
                <div className="flex flex-col gap-4 justify-center">
                    ...
                    <p>
                        Note that the dough has expanded and fills the basket fully, but is not overlowing.
                    </p>
                    <p>
                ...
                <div className="flex flex-col text-center gap-2 w-2/5 mx-auto">
                    <img src={rise2.src} alt="properly proofed"/>
                    <p>poperly proofed loaf in it's banneton</p>
                </div>
            </div>
            <div className="flex gap-4">
                <div className="flex flex-col text-center gap-2 w-2/5 mx-auto shrink-0">
                    <img src={Baking1.src} alt="hot pan in a hot oven"/>
                    <p>hot oven, hot pan</p>
                </div>
                <div className="flex flex-col gap-4 justify-center">
                    <p>
            ...
            <div className="flex gap-4">
                <div className="flex flex-col text-center gap-2 w-2/5 mx-auto shrink-0">
                    ...
                    <p>steamed bread expands well</p>
                </div>
            ...
            <div className="flex gap-4 w-4/5 mx-auto">
                <div className="flex flex-col text-center gap-2 w-2/5 mx-auto shrink-0">
                    ...
                    <p>dark carmel crust is done</p>
                </div>
                <div className="flex flex-col text-center gap-2 w-2/5 mx-auto shrink-0">
                    <img src={Baked2.src} alt="the web is now stretched"/>
                    <p>the web is now stretched</p>
                </div>
            </div>
            <p>
            ...
            <div className="flex flex-col text-center gap-2 mx-auto shrink-0">
                ...
                <p>I like to make two at a time</p>
            </div>
        </section>
    )
}